  ...
  return (
    <aside className="lg:col-span-3 space-y-6">
        <div className="w-full">
                ...
                <div className="text-[10px] text-gray-400 mt-2 border-t border-gray-100 pt-2">1 de dezembro de 2025</div>
                </div>
        </div>

        <AdSpot position="sidebar_1" className="w-full bg-white border border-gray-200 p-1" />
        <AdSpot position="sidebar_2" className="w-full bg-white border border-gray-200 p-1" />

        <NewsletterWidget />

        <AdSpot position="sidebar_3" className="w-full bg-white border border-gray-200 p-1" />
        <AdSpot position="sidebar_4" className="w-full bg-white border border-gray-200 p-1" />
