...
-- 1. Clean up any existing corrupted records for this email
...
BEGIN
  ...
  -- FIX: Removed ::text cast because the database reported column "id" is of type uuid
  INSERT INTO auth.identities (
    id,
    user_id,
    identity_data,
    ...
    new_user_id, -- Passed directly as uuid
    new_user_id,
